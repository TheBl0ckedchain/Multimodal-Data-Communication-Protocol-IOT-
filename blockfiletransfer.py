...
class Blockchain:
    ...
    def proof_of_work(self, last_proof):
        """Simple Proof of Work Algorithm: Find a number `p` such that hash(p*last_proof) contains 4 leading zeros."""
        proof = 0
    ...
    def resolve_conflicts(self):
        """This is the consensus algorithm. It replaces our chain with the longest one in the network."""
...
def mine():
    ...
    blockchain.new_transaction(sender="0", recipient=node_identifier, data="Mining Reward")
